...
const Traffic = () => {
  return (
    <div className="h-[50vw] w-full flex flex-col pb-[3rem]">
      <div className="flex justify-center items-center mt-[6.625rem] mb-[2.875rem]">
        <span className="text-[#9164FF] text-[2.1875rem]">全网流量</span><span className="text-white text-[1.75rem]">-海量直连媒体拥有优先挑量权，流量质量、规模有保障</span>
      </div>
