...
const Home = () => {
  ...
  return (
    <div
      ...
      <div
      className={
        cn("absolute left-0 bottom-0 md:w-[48.95%] w-full md:rounded-tr-[12.25rem] rounded-tr-[5rem] md:rounded-tl-[0] rounded-tl-[5rem]  md:px-[4.6875rem] px-3 pb-[0.875rem] pt-[1.8125rem]", IS_FIRST ? "bg-[#7A53DA]/70" : "md:bg-about-us-tip bg-m-about-us-tip")
      }
      
      >
        <h1 className="text-white w-fit md:ml-0 mx-auto mb-[2.25rem] font-semibold text-xl leading-7 relative after:absolute after:content-[''] after:h-1 after:left-0 after:right-0 after:-bottom-4 after:bg-white">
          关于我们
        </h1>
